...
public class GestionDatos {
	...
	public RespuestaColocacion CompruebaTresEnRaya() {
		if (tablero.compruebaFila()||tablero.compruebaColumna()||tablero.compruebaDiagonal()) {
			return new RespuestaColocacion(true, "Enhorabuen Champion, has hecho tres en raya");			
		}
		return  new RespuestaColocacion(false, "prueba otra vez inutil");
